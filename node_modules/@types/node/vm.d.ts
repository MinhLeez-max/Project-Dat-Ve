...
declare module "vm" {
     ...
     * the JavaScript [`eval()`](https://developer.mozilla.org/vi-VN/docs/Web/JavaScript/Reference/Global_Objects/eval) function to run the same code:
     *
     * ```js
     * import vm from 'node:vm';
     ...
     * [`eval()`](https://developer.mozilla.org/vi-VN/docs/Web/JavaScript/Reference/Global_Objects/eval) _does_ have access to the
