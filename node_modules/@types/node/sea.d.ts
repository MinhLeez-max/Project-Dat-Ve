 ...
 * ```
 *    * On Windows (optional):
 * [signtool](https://learn.microsoft.com/vi-VN/windows/win32/seccrypto/signtool) can be used from the installed [Windows SDK](https://developer.microsoft.com/vi-VN/windows/downloads/windows-sdk/).
 * If this step is
...
declare module "node:sea" {
    ...
    /**
     * Similar to `sea.getAsset()`, but returns the result in a [`Blob`](https://developer.mozilla.org/vi-VN/docs/Web/API/Blob).
     * An error is thrown when no matching asset can be found.
     * @since v20.12.0
     */
