...
declare module "fs" {
     ...
     * \[0, [`Number.MAX_SAFE_INTEGER`](https://developer.mozilla.org/vi-VN/docs/Web/JavaScript/Reference/Global_Objects/Number/MAX_SAFE_INTEGER)\] range. If `fd` is specified and `start` is
